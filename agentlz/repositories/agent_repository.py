...
def list_agents(
    *,
    ...
    list_sql = text(
        f"""
        SELECT id, name, tenant_id, created_at, created_by_id, updated_at, updated_by_id, disabled
        FROM `{table_name}`
        {where_sql}
...
def create_agent(
    *,
    ...
    sql = text(
        ...
        (name, tenant_id, created_at, created_by_id, disabled)
        VALUES (:name, :tenant_id, :created_at, :created_by_id, :disabled)
        """
    )
    ...
    with engine.begin() as conn:
        ...
        ret = conn.execute(
            text(
                f"SELECT id, name, tenant_id, created_at, created_by_id, updated_at, updated_by_id, disabled FROM `{table_name}` WHERE id = :id AND tenant_id = :tenant_id"
            ),
