...
CREATE TABLE `announcement` (
  ...
  `created_by_id` bigint(20) UNSIGNED NULL DEFAULT NULL,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_by_id` bigint(20) UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_announcement_tenant` (`tenant_id`) USING BTREE,
  INDEX `idx_announcement_disabled` (`disabled`) USING BTREE,
  INDEX `idx_announcement_created_at` (`created_at`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `document` (
    ...
    `meta_https` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '元数据链接（如预览地址）',
...
CREATE TABLE `model` (
  ...
  `price` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '价格（文本）',
  `description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '说明（长文本）',
  `manufacturer` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '厂家/提供方',
  `tags` json NULL COMMENT '标签数组（JSON Array）',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_model_name`(`name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
